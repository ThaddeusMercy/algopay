  ...
  const fetchBalances = async () => {
    ...
    try {
      ...
      if (isWalletConnected() && connectedAddress) {
        ...
        const algoPrice = 0.42; // Example ALGO price in USD
        const totalUSD = accountBalance.algo * algoPrice;
        
        // Count total assets (ALGO + ASAs with positive balance)
        const totalCoins = (accountBalance.algo > 0 ? 1 : 0) + accountBalance.assets.length;
        
        setBalances({
          totalUSD: totalUSD,
          algo: accountBalance.algo,
    ...
    <div className="flex items-center justify-between py-2 sm:py-3 border-b border-gray-200 last:border-b-0">
      ...
      <div className="text-right">
        <div className="font-medium text-gray-900 text-sm sm:text-base">
          {symbol === 'ALGO' ? `$${(amount * 0.42).toFixed(2)}` : '--'}
        </div>
        {symbol === 'ALGO' && (
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="space-y-1 mb-4 sm:mb-6">
            ...
            {balances.algo === 0 && balances.assets.length === 0 && (
          ...
          <div className="bg-gray-100 border border-gray-200 rounded-lg p-3 mt-4 sm:mt-6">
            ...
            <div className="text-xs sm:text-sm text-gray-700">
              {balances.totalUSD > 0 
                ...
                : isWalletConnected() 
                ? 'Consider adding ALGO or other assets to your wallet'
