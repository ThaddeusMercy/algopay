    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-3 sm:p-4">
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200">
          <div>
            <h2 className="text-lg sm:text-2xl font-bold text-gray-900">Edit Employee</h2>
            <p className="text-gray-600 text-xs sm:text-sm">Update {employee.name}'s information</p>
          </div>
          <button
        ...
        {showDeleteConfirm && (
          <div className="p-4 sm:p-6 border-b border-gray-200 bg-red-50">
            <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-red-800">Delete Employee</h3>
