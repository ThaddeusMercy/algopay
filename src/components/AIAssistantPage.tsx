        ...
        setMessages([
          {
            ...
            type: 'assistant',
            content: `Hello! I'm your smart AI assistant for ${companyName}. I'm powered by Google Gemini AI and have deep knowledge about your company data, payroll operations, and Algorand blockchain technology. I can analyze your employee data, provide payment insights, explain blockchain concepts, and have natural conversations. What would you like to know?`,
            timestamp: new Date()
          }
        ]);
      }
      ...
      <div className="flex-shrink-0 bg-white border-t border-gray-200 px-3 py-3 sm:px-6 sm:py-4">
        <div className="flex items-center space-x-2 sm:space-x-3">
          <input
            ...
            placeholder={isMobile ? "Ask me anything..." : "Ask me anything about your company, employees, payments, or Algorand blockchain..."}
