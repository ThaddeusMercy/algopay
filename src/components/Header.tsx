...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  const landingNavItems = [
    ...
    { id: 'pricing', label: 'Pricing', scrollTo: 'pricing-section' }
  ];
                      ...
                      {showWalletMenu && (
                        <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-xl z-50">
                          <div className="p-4 border-b border-gray-200">
                            ...
                            <div className="text-gray-900 font-mono text-sm break-all">{walletAddress}</div>
                          </div>
                          <div className="p-2">
                            <button
                              onClick={() => {
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-xl z-50">
                      <div className="p-4 border-b border-gray-200">
                        ...
                        <div className="text-gray-900 text-sm truncate">{user?.email}</div>
                      </div>
                      <div className="p-2">
                        <button
                          onClick={() => {
                    ...
                    {isWalletConnected ? (
                      <div className="space-y-2">
                        <div className="px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg">
                          <div className="text-sm text-gray-700 mb-1">Connected Wallet</div>
